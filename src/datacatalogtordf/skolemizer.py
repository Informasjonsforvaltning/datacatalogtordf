...
class Skolemizer:
    ...
    def add_skolemization() -> str:
        """Create a skolemization URI for a resource without an identifier."""
        _skolemization = (
    ...
    @staticmethod
    def get_baseurl() -> str:
        """Return baseurl for skolemization."""
        _baseurl = (
            os.environ[Skolemizer.baseurl_key]
            if Skolemizer.baseurl_key in os.environ
